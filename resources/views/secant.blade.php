...
<body>
    <header>
        <div class="m-6 mt-10 mb-10 text-center font-bold text-3xl uppercase">
            <h1>Perhitungan Secant Method</h1>
        </div>
    </header>
    <div class="content">
        <form action="" method="post" class="m-3 p-6 border rounded-lg">
            ...
            <div class="">
                ...
                <div class="flex items-center mb-3">
                    ...
                    <input class="border rounded-md w-24 p-1" type="number" name="x0" required />
                </div>
                <div class="flex items-center mb-3">
                    <h1 class="pr-[44px]">Input Bilangan 2</h1>
                    <input class="border rounded-md w-24 p-1" type="number" name="x1" required />
                </div>
                <div class="flex items-center mb-3">
                    <h1 class="pr-[25px]">Input Nilai Tebakan</h1>
        ...
        <div class="m-3 p-6 border rounded-lg shadow-lg">
            <h1 class="font-bold text-xl">Hasil Secant Method</h1>
                    ...
                    <div class="py-4 inline-block min-w-full sm:px-6">
                        <div class="overflow-hidden">
                            <table class="min-w-full text-center border">
                                ...
                                <tbody>
                                    @foreach ($secant as $x0 => $x1)
                                        @foreach ($secant as $f0 => $f1)
                                            @foreach ($secant as $xn1 => $iterasi)
    ...
    <footer>
        <div class="w-auto mt-44 border-t border-slate-500 bg-slate-800">
            <div class="flex items-center justify-center mb-5 mt-5">
                <a href="https://github.com/odetv/aritmatika-laravel" target="_blank"
